...
--
-- Database: `dm_comparator`
--
CREATE DATABASE IF NOT EXISTS `dm_comparator` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `dm_comparator`;
...
CREATE TABLE `messages` (
  ...
  `dm_version` tinyint(1) NOT NULL COMMENT '1 para el primer DM, 2 para el segundo',
